...
class Launcher(LauncherBase):
    ...
    def input_data(self, **kwargs) -> None:
        """
        Receives the input data to create a circuit and stores it in the _dic_input dictionary.
        ...
        Args:
            **kwargs: Arbitrary keyword arguments representing the input data for launching a given circuit.
        """
    ...
    def remove_data(self, *args) -> None:
        """
        Removes the input data for launching a given circuit from the _dic_input dictionary.

        Args:
            *args: Arbitrary arguments representing the keys of the input data to be removed.
        """
        for key in args:
            if key in self._dic_input.keys():
    ...
    def check_data(self) -> dict:
        """
        Checks the current status of the launch data, returning the list of filled and/or unfilled data.

        Returns:
            dict: Dictionary with the list of filled and/or unfilled data.
        """
    ...
    def _generate_launcher_id(self, launcher_id: Any = 'auto') -> str:
        ...
        Args:
            launcher_id (Any, optional): 
                ID of the launch. If 'auto', a unique ID will be automatically generated.

        Returns:
            str: Unique ID of the launch.
        """
        if launcher_id == 'auto':
