...
class Matrices(MatricesBase):
    ...
    def __init__(self, table_path):
        ...
        self.seller_sector_agent = "SetorDoAgenteQueVendeI"
        self.buyer_sector_agent = "SetorDoAgenteQueCompraI"
    ...
    def create_matrices(self, df: pd.DataFrame, product: str, matrice_type:str):
        ...
        #agrupa os dados
        result_df = df.groupby([self.seller_sector_agent, self.buyer_sector_agent])['Quantidade'].sum().reset_index()
